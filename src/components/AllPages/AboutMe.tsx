...
export default function AboutMe() {
    const personalDetails = [
        ...
        { key: "Email :", value: "trilochanbeherait@gmail.com" },
            ...
            <div className="col-span-2 px-4">
                ...
                <div className="flex justify-between items-center my-8">
                    <div className="flex gap-2 h-full text-[#8e8e8e] cursor-pointer">
                        ...
                        <Link href="mailto:trilochanbeherait@gmail.com"> <p className='text-red-600 bg-[#ffffff] rounded-lg p-2'> <MdOutgoingMail /> </p></Link>
